// The Messages
		...
		#define	TRACK_VOLUME	1206
		#define	TRACK_PANNER	1208
		...
		#define	TRACK_MIDI_IN_EN		1221
		#define	TRACK_MIDI_IN_CH		1222		
		#define	TRACK_OUTPUT_LINE		1223
		...
		#define	PL_LOOP_ENABLE	1513
		#define	PL_LOOP_POINT1	1514
		#define	PL_LOOP_POINT2	1515
		...
		#define	SONG_VST_FILENAME	2081
		
			
		//message like style >3000
		
		#define	TRACK_SPECIFIC_DATA_START 3000  //old (nomore in 1.3)
		
		#define	BOOSTER_SETTINGS		  3001
		#define	TRACK_SETTINGS			  3002
		#define	MIXER_SETTINGS			  3003
